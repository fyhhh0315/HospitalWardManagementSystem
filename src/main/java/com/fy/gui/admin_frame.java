...
import com.fy.gui.bed.Insert_Bed;
import com.fy.gui.bed.Manage_Bed;
import com.fy.gui.department.Insert_Department;
import com.fy.gui.department.Manage_Department;
import com.fy.gui.doctor.Insert_Doctor;
import com.fy.gui.doctor.Manage_Doctor;
import com.fy.gui.patient.Insert_Patient;
import com.fy.gui.patient.Manage_Patient;
import com.fy.gui.ward.Change_Notion;
import com.fy.gui.ward.Insert_Ward;
import com.fy.gui.ward.Manage_Ward;
...
public class admin_frame extends Jtable{
	...
	public admin_frame() {
		...
		change_notion=new JMenuItem("确认修改");
		...
		change_notion.addActionListener(listen);
